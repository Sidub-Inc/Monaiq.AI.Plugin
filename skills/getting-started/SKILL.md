...
description: State-aware onboarding flow controller — detects user progress, routes to next action, supports Quick Start for greenfield users
auto-invoke:
  - "User wants to get started with Monaiq licensing"
  - "User asks what Monaiq can do for them"
  - "User is new to Monaiq and needs orientation"
