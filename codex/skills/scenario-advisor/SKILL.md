...
description: Licensing scenario advisor with context flow — matches your app type to recommended licensing models and passes the selected scenario downstream
auto-invoke:
