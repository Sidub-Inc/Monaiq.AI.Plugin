...
description: Diagnoses and resolves Monaiq SDK integration issues using structured decision trees across 4 error categories
auto-invoke:
  - "User is having trouble integrating the Monaiq licensing SDK"
  - "User encounters an error with licensing setup, authentication, or validation"
  - "User asks for help debugging a licensing integration issue"
